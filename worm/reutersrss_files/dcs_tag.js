...
//	var gFpcDom=".reuters.com";
//var gFpcDom=""; No longer setting this for cross domain support
...
function dcsVar(){
    if (document.cookie.indexOf("UserID")!=-1){WT.dcsvid=dcsGetCookie("UserID");}
    WT.z_domain=window.location.hostname;
	var dCurrent=new Date();
